...
{"path":"./src/app/services/template.service.ts","models":["Template"],"methods":[{"name":"getTemplates","params":[],"return":"Observable<Template[]>"},{"name":"getTemplateById","params":[{"templateId":"number"}],"return":"Observable<Template>"}]}



# prompt

Please create an TemplateService as Angular Service class.
