...
{"path":"./src/app/services/notification.service.ts","models":["Notification"],"methods":[{"name":"sendNotification","params":[{"userId":"number"},{"notification":"Notification"}],"return":"Observable<boolean>"}]}



# prompt

Please create an NotificationService as Angular Service class.
