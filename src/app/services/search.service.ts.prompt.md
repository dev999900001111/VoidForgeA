...
{"path":"./src/app/services/search.service.ts","models":["Project","Content","Filter"],"methods":[{"name":"searchProjects","params":[{"query":"string"},{"filters":"Filter[]"}],"return":"Observable<Project[]>"},{"name":"getSuggestedContent","params":[{"userId":"number"}],"return":"Observable<Content[]>"}]}



# prompt

Please create an SearchService as Angular Service class.
