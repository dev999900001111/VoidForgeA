...
{"path":"./src/app/services/user.service.ts","models":["User","NotificationSetting"],"methods":[{"name":"getUserById","params":[{"userId":"number"}],"return":"Observable<User>"},{"name":"updateUser","params":[{"user":"User"}],"return":"Observable<User>"},{"name":"getUserNotificationSettings","params":[{"userId":"number"}],"return":"Observable<NotificationSetting[]>"},{"name":"updateUserNotificationSettings","params":[{"userId":"number"},{"settings":"NotificationSetting[]"}],"return":"Observable<boolean>"}]}
