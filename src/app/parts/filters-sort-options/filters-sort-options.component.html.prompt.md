...
Please carefully review the design information up to this point and create the html for the FiltersSortOptionsComponent, keeping in mind the division of roles according to the screen list.
...
Please respond only to filters-sort-options.component.html.
