...
Please carefully review the design information up to this point and create the html for the FooterComponent, keeping in mind the division of roles according to the screen list.
...
Please respond only to footer.component.html.
